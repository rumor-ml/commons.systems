...
import { monitorRun, MonitorRunInputSchema } from './tools/monitor-run.js';
import { monitorPRChecks, MonitorPRChecksInputSchema } from './tools/monitor-pr-checks.js';
      ...
      },
      {
        ...
        inputSchema: {
          ...
          properties: {
            ...
            pr_number: {
              type: 'number',
              description: 'PR number to extract URLs from (will use latest run for this PR)',
            },
            branch: {
              type: 'string',
              description: 'Branch name to extract URLs from (will use latest run for this branch)',
            },
            repo: {
              type: 'string',
              description: 'Repository in format "owner/repo" (defaults to current repository)',
      ...
      },
      {
        ...
        inputSchema: {
          ...
          properties: {
            ...
            branch: {
              type: 'string',
              description: 'Branch name to analyze (will use latest run for this branch)',
            },
            repo: {
              type: 'string',
              description: 'Repository in format "owner/repo" (defaults to current repository)',
