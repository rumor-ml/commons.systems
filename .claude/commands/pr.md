...
4. Monitor PR checks using `gh pr checks --watch --fail-fast`. Continue watching until no checks are in progress. If checks remain pending but none are in progress, this indicates an error - report it and do not continue waiting.
