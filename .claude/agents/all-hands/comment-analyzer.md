...
For in-scope issues, ALWAYS provide the `files_to_edit` array listing all files that need modification to fix the comment issue. Include the primary file and any related files that need changes.
