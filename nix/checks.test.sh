...
# Test 16: home-manager-build-check skips when no Home Manager files changed
...
# Test 17: home-manager-build-check detects nix/home/ changes
...
# Test 18: home-manager-build-check detects flake.nix changes
...
# Test 19: home-manager-build-check fails when origin/main missing
...
# Test 20: home-manager-build-check validates regex pattern matches correctly
...
# Test 21: CI workflow Home Manager build step validates configuration
...
# Test 22: WezTerm Lua validation hook with valid config
...
# Test 23: WezTerm Lua syntax pre-commit hook execution (E2E)
...
# Test 24: Home Manager build check pre-push hook execution (E2E)
