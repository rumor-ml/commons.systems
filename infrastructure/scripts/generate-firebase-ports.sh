...
# Output: Lines like "AUTH_PORT=9099" using heredoc (ensures all variables are output
#         atomically in one write operation with consistent line endings when sourced)
