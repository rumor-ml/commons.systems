...
describe('Step Constants', () => {
  ...
  it('should have all steps defined in STEP_NAMES', () => {
    ...
    assert.strictEqual(STEP_NAMES[STEP_PHASE1_PR_REVIEW], 'Phase 1: PR Review');
    assert.strictEqual(STEP_NAMES[STEP_PHASE1_SECURITY_REVIEW], 'Phase 1: Security Review');
    ...
    assert.strictEqual(STEP_NAMES[STEP_PHASE2_PR_REVIEW], 'Phase 2: PR Review');
    assert.strictEqual(STEP_NAMES[STEP_PHASE2_SECURITY_REVIEW], 'Phase 2: Security Review');
