...
# ==================== Step 6: Instructions for updating push.yml ====================
...
echo ""
echo "You must update .github/workflows/push.yml to add ${SITE_NAME}."
echo "Follow this pattern (search for 'fellspiral' and replicate the steps):"
echo ""
echo "1. In local-tests job, add ${SITE_NAME} change detection:"
echo "   - Add output: ${SITE_NAME}-changed"
echo "   - Add check step similar to fellspiral"
echo "   - Add test step for ${SITE_NAME}"
echo ""
echo "2. Add deploy-${SITE_NAME} job:"
echo "   - Copy deploy-fellspiral job"
echo "   - Rename to deploy-${SITE_NAME}"
echo "   - Update SITE_NAME and outputs"
echo "   - Update condition to check ${SITE_NAME}-changed"
echo ""
echo "3. Add playwright-tests-${SITE_NAME} job:"
echo "   - Copy playwright-tests-fellspiral job"
echo "   - Rename to playwright-tests-${SITE_NAME}"
echo "   - Update dependencies to deploy-${SITE_NAME}"
echo ""
echo "4. Add rollback-${SITE_NAME} job (if deploying to main):"
echo "   - Copy rollback-fellspiral job"
echo "   - Rename to rollback-${SITE_NAME}"
echo "   - Update dependencies to playwright-tests-${SITE_NAME}"
echo ""
echo "Next commands:"
