...
echo "2. Update workflows - see CLAUDE.md section 'Adding a New Site to Workflows'"
echo "3. Test locally: npm run dev:${SITE_NAME}"
echo "4. Deploy manually via GitHub Actions → Manual Deploy - ${SITE_NAME_CAPITALIZED}"
echo ""
